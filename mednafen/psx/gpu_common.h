...
#define ModTexel2(dither_offset_r, dither_offset_g, dither_offset_b, texel, r, g, b) ((texel & 0x8000) | (dither_offset_r[(((texel & 0x1F)  * (r))   >> (5 - 1))] << 0) | (dither_offset_g[(((texel & 0x3E0)  * (g))  >> (10 - 1))] << 5) | (dither_offset_b[(((texel & 0x7C00) * (b)) >> (15 - 1))] << 10))
